...
nbmax=max(nbcopy)
nbmin=min(nbcopy)
posimax=nbcopy.index(nbmax)
posimin=nbcopy.index(nbmin)
    
print(f"La liste modifiée est : {nbcopy}")
print(f"le nombre le plus petit est {nbmin} et sa position est {posimin}")
print(f"le nombre le plus grand est {nbmax} et sa position est {posimax}")